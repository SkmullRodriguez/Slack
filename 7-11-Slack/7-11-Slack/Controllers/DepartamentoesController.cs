...
namespace _7_11_Slack.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdDepartamento,Departamento1")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdDepartamento,Departamento1")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
